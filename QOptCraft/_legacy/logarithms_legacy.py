...
def logm_2(file_input=True, A=False, file_output=True, filename=False, txt=False, acc_d=3):
    file_input, filename, filler, acc_d = input_control(
        10, file_input, A, file_output, filename, txt, acc_d, False
    )
...
def logm_3(file_input=True, A=False, file_output=True, filename=False, txt=False, acc_d=3):
    file_input, filename, filler, acc_d = input_control(
        10, file_input, A, file_output, filename, txt, acc_d, False
    )
...
def logm_4(file_input=True, A=False, file_output=True, filename=False, txt=False, acc_d=3):
    file_input, filename, filler, acc_d = input_control(
        10, file_input, A, file_output, filename, txt, acc_d, False
    )
...
def logm_5(file_input=True, A=False, file_output=True, filename=False, txt=False, acc_d=3):
    file_input, filename, filler, acc_d = input_control(
        10, file_input, A, file_output, filename, txt, acc_d, False
    )
