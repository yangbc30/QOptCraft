...
def Toponogov(file_input=True,U_input=False,file_output=True,filename=False,base_input=False,tries=False,m=False,n=False,acc_d=3,txt=False,acc_t=8,vec_base=[[False,False],[False,False]]):
	'''
