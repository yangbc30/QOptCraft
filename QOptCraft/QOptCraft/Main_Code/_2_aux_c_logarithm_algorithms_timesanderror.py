...
def MatLogCompTnE(N1=False,N2=False,txt=False,exp=False):
	...
	cell_format_number_end=workbook.add_format({'center_across' : True, 'left' : True, 'right' : True, 'bottom' : True, 'valign': 'vcenter'})
	...
	for i in range(N1,N2+1):
		...
		if exp==1:
			...
			scores_time = {"N" : f"{i}", "Deviation": dev, "Algorithm 1" : time_1/(10.0**9), "Algorithm 2" : time_2/(10.0**9), "Algorithm 3" : time_3/(10.0**9), "Algorithm 4" : time_4/(10.0**9), "Algorithm 5" : time_5/(10.0**9)} # your score time data (in seconds)
			scores_error = {"N" : f"{i}", "Deviation": dev, "Algorithm 1" : inner_prod_1, "Algorithm 2" : inner_prod_2, "Algorithm 3" : inner_prod_3, "Algorithm 4" : inner_prod_4, "Algorithm 5" : inner_prod_5} # your score error data
			...
			scores_time = {"N" : f"{np.power(2,i)}", "Deviation": dev, "Algorithm 1" : time_1/(10.0**9), "Algorithm 2" : time_2/(10.0**9), "Algorithm 3" : time_3/(10.0**9), "Algorithm 4" : time_4/(10.0**9), "Algorithm 5" : time_5/(10.0**9)} # your score time data (in seconds)
			scores_error = {"N" : f"{np.power(2,i)}", "Deviation": dev, "Algorithm 1" : inner_prod_1, "Algorithm 2" : inner_prod_2, "Algorithm 3" : inner_prod_3, "Algorithm 4" : inner_prod_4, "Algorithm 5" : inner_prod_5} # your score error data
		...
		for name in scores_time:
			...
			if i==N2:
				...
				worksheet.write(row, col, scores_time[name], cell_format_number) # write score at row 'row' and column 'col'
				worksheet.write(row, col+8, scores_error[name], cell_format_number) # write score at row 'row+1' and column 'col'
