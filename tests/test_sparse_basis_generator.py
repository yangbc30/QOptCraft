...
def test_sparse_basis_generator(m, dim, photons, base_input) -> None:
    ...
    u_m_sparse, u_M_sparse, u_m_e_sparse, u_m_f_sparse, sep_sparse, U_m_sparse, U_M_sparse = matrix_u_basis_generator_sparse(m, dim, photons, base_input)
