...
QOptCraft(file_input=False,filename="S_dim6",newfile=True,
	file_output=True,module=1,impl=0,N=6)

# Obtaination of "S_dim6.txt"'s evolution of n=4 photons U. 
# 'S_dim6_m_6_n_4_coefs_method_2.txt' is generated.
QOptCraft(file_input=True,filename="S_dim6",
	file_output=True,module=2,n=4,method=2)
...
QOptCraft(module=6,file_input_state=True,file_input_matrix=True,
	filename_state="3_vectors_in_Fock_basis_for_Schmidt_measurement",
	filename_matrix="S_dim6_m_6_n_4_coefs_method_2",
	base_input=False,acc_d=2,txt=False,fidelity=0.8)